...
import { ArrowLeft, MapPin, Award, Mail } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className="flex flex-col">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  <Mail className="w-5 h-5" style={{ color: 'var(--saffron)' }} />
                  <p className="text-sm font-semibold">Craft Type</p>
                </div>
                <p>{artisan.craft}</p>
              </div>
            </div>
            ...
            {/* Contact Button */}
            <button
              className="w-full px-6 py-4 rounded-lg text-white font-semibold hover:opacity-90 transition-opacity"
